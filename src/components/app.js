                        ...
                        <div id="nav" className="col-12 col-md-3 col-xl-2 bd-sidebar">
                            <div className="row">
                                <div className="col-md-12 col-8">
                                    <div className="text-sm-left text-md-center logo">SESP<span id="beta"> Logo</span></div>
                                </div>
                    ...
                    <!-- chart row start -->  */}
                            <div className="row mt-3 db-chart">
                                ...
                                <div id="parent2" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text2">Energy produced per hour</div>
                                ...
                                <div id="parent4" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text4">ACTIVE Energy Sources</div>
                    ...
                    <!-- energy tip start --> */}
                            <div className="row">
                                <div className="col-md-12 pb-3">
                                    <span className="footer-text-1">SESP 2019 </span><span className="footer-text-2">Holder</span>
                                </div>
                            </div>
